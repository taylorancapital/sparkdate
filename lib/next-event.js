...
function normalizeEvent(id, e) {
  ...
  const venueLabel = e.venue
    ...
    : 'Philadelphia';
  // Single-price model; fall back to legacy gender-split fields.
  const price = Number(e.price || e.priceMen || e.priceWomen || 0);
...
${bodyHtml}
    ...
    <div style="background:#0a0e27;padding:28px 30px;text-align:center;color:#888888;font-size:12px;">
      <p style="margin:0 0 6px;">SparkDate · Philadelphia · Real people. Real venues.</p>
